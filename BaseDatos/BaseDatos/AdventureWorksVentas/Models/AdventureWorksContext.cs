...
public partial class AdventureWorksContext : DbContext
{
    ...
    public virtual DbSet<vSalesPersonSalesByFiscalYears2025> vSalesPersonSalesByFiscalYears2025s { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AWBuildVersion>(entity =>
        {
            ...
            entity.ToTable("AWBuildVersion", tb => tb.HasComment("Current version number of the AdventureWorks 2025 sample database. "));
        ...
        modelBuilder.Entity<vSalesPersonSalesByFiscalYears2025>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vSalesPersonSalesByFiscalYears2025", "Sales");
